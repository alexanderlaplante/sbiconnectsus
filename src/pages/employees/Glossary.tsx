...
const GLOSSARY: GlossaryEntry[] = [
  ...
  { acronym: "BOM", standsFor: "Bill of Materials", category: "Standards & Organizations", description: "A comprehensive list of all components, parts, and materials required for a project.", details: "A Bill of Materials (BOM) is a structured document listing every item needed to complete a project, including quantities, part numbers, descriptions, and costs. In low-voltage and IT infrastructure projects, a BOM typically includes cables, connectors, patch panels, racks, switches, cameras, and labor items. BOMs are essential for accurate procurement, budgeting, and project tracking." },
  { acronym: "ROM", standsFor: "Rough Order of Magnitude", category: "Standards & Organizations", description: "A high-level estimate applied to a Bill of Materials to provide an early cost projection.", details: "A ROM estimate is created during the early conceptual or initiation phase of a project when detailed designs and specifications are limited. It typically carries -25% to +75% accuracy and is based on expert judgment, historical data, and benchmarks. ROM estimates support early decision-making, helping stakeholders evaluate feasibility and compare alternatives without committing to a detailed, definitive estimate. Not suitable for procurement or execution planning." },
  { acronym: "ROM BOM", standsFor: "Rough Order of Magnitude Bill of Materials", category: "Standards & Organizations", description: "A preliminary list of major parts and costs used to calculate a ROM estimate.", details: "A ROM BOM combines a Rough Order of Magnitude (ROM) cost estimate with a preliminary Bill of Materials (BOM). It is used during project initiation to determine financial feasibility before detailed engineering begins. Typically produced in 1–3 days with -25% to +75% accuracy, it enables go/no-go decisions, early budgeting, and resource planning. ROM refers to the early-stage cost estimate while BOM is the structured component list." },
  ...
  { acronym: "NO", standsFor: "Normally Open", category: "Security & Access", description: "A contact or circuit that is open in its default, unenergized state.", details: "A Normally Open (NO) contact remains open with no current flow until the controlling device (switch, relay, or sensor) is activated, closing the contact. Common uses include start buttons, control relays, sensor outputs, and logic inputs. NO configurations are widely applied in control systems where an action should only occur when explicitly triggered, providing fail-safe behavior by preventing unintended activation during power loss." },
  { acronym: "NC", standsFor: "Normally Closed", category: "Security & Access", description: "A contact or circuit that is closed in its default, unenergized state.", details: "A Normally Closed (NC) contact remains closed with current flowing until the controlling device is activated, opening the contact and interrupting current. NC configurations are used in safety-critical applications such as emergency stop (E-stop) circuits, safety interlocks, and fault detection loops, where a loss of power or broken connection must result in a safe shutdown. This fail-safe behavior makes NC contacts essential in industrial enclosures and door interlock circuits." },
