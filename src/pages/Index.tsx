        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative z-10 mx-auto max-w-7xl px-6 py-24 w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block relative" style={{ perspective: 1200 }}>
              <FloatingCard delay={0} className="absolute -top-8 right-0 w-56">
              ...
              <FloatingCard delay={1.2} className="absolute top-24 right-32 w-52">
              ...
              <FloatingCard delay={3.6} className="absolute top-[22rem] right-36 w-52">
